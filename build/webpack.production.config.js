...
var env = require('../config/build.env');
...
var webpackConfig = merge(baseConfig,{
    ...
    output: {
        path: config.build.assetRoot, //因为这里是生成的打包后的路径
        ...
        new  CopyWebpackPlugin([
            {
                ...
                to: config.build.assetSubDirectory,//为什么不是 config.build.assetRoot + config.build.assetSubDirectory,因为会直接放在assetSubDirectory ，不需要绝对地址
                ignore: ['.*']
            }
        ]),
